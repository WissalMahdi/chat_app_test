...
import 'package:chat_app_test/Espace_Apprenant/Acceuil_Apprenant/FeedBox.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            feedBoxApprenant(avatarUrl[6], "Mr.Mouhamed_Becha", "50 min",
            ...
            feedBoxApprenant(
                ...
                ""),
            feedBoxApprenant(avatarUrl[2], "M.Saber_HJ", "1 h",
                "y a pas du cours mécanique le 25-10-2022", storyUrl[2]),
            feedBoxApprenant(
                avatarUrl[1], "Karim Bani", "à l'instant", text, ""),
          ],
        ),
      ),
    );
