...
class RouteOne1 extends StatelessWidget {
  final List<PhotoItem> _items = [
    ...
    PhotoItem(
        ...
        "j'ai perdue ma carte d'identité , est ce que quelqu'un d'entre vous trouve il svp"),
    PhotoItem(
    ...
    PhotoItem(
        "https://lh3.googleusercontent.com/p/AF1QipP353yQ5wjCgo6ltAMfo5v7hYO8ivxkj4SOzrN9=w768-h768-n-o-v1",
        ""),
    ...
    PhotoItem(
        ...
        " un trés bon film, merci à vous pour cette belle ambiance"),
