...
import 'package:chat_app_test/Espace_Formateur/Acceuil_Formateur/FeedBox.dart';
  ...
  Widget appBar(BuildContext context) {
    return AppBar(
      ...
      actions: [
        IconButton(
            onPressed: (() {
              Provider.of<UploadPostFormateur>(context, listen: false)
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            feedBoxFormateur(avatarUrl[6], "Mr.Mouhamed_Becha", "50 min",
