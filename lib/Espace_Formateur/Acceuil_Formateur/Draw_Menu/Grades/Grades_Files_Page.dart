...
class FilesPageGrades extends StatefulWidget {
  final List<PlatformFile> files;
  final ValueChanged<PlatformFile> onOpenedFile;

  const FilesPageGrades({
    Key? key,
    required this.files,
  ...
  @override
  State<FilesPageGrades> createState() => _FilesPageState();
}

class _FilesPageState extends State<FilesPageGrades> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromARGB(255, 43, 56, 231),
      ),
    );
  }
